...
<body>
  <div class="home-container">
    ...
    <main class="feed perfil-page" id="mi-perfil-main">
      ...
      <%-- Muestra el nombre de usuario y el avatar del objeto viewedUser --%>
        <section class="perfil-info">
          <img src="${viewedUser.avatar}" alt="Foto de perfil" class="perfil-img">
          <div class="perfil-datos">
            <h2 id="perfil-username-main">${viewedUser.username}</h2>
            <p class="usuario" id="perfil-username-at">@${viewedUser.username}</p>

            <%-- Botón Editar: Solo aparece si el Servlet confirmó que es MI perfil --%>
